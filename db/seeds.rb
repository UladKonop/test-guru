...
question = Question.create!(body: 'Is the JS language related to the java language?', test_id: test.id)
question1 = Question.create!(body: 'What is the name of libraries in the Ruby language?', test_id: test1.id)
...
question5 = Question.create!(body: 'How to find out the username in the console?', test_id: test5.id)
